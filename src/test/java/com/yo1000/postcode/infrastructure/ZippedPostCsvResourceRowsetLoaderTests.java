...
public class ZippedPostCsvResourceRowsetLoaderTests {
    @Test
    void test_load() throws IOException {
        ...
        ZippedPostCsvResourceRowsetLoader<PostCsv> loader = new ZippedPostCsvResourceRowsetLoader<>(csvProps, csvMapper);
